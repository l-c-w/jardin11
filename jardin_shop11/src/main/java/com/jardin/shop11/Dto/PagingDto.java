...
public class PagingDto {
	...
	private int curPage = 1; // 현재 페이지 위치
	...
	// 게시판 페이지 갯수
	public void setPage_cnt(int listCnt, int page_size) {
		if (listCnt % page_size == 0) {
			this.page_cnt = listCnt / page_size;
		} else {
			this.page_cnt = listCnt / page_size + 1;
		}
	}
	...
	public void setEnd_page(int cur_range, int range_cnt, int listCnt) {
